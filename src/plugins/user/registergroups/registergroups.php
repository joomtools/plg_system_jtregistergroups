 ...
 * @since  1.6
 */
class PlgUserRegistergroups extends JPlugin
{
	/**
	 * Allowed Groups.
	 *
	...
	public function onContentPrepareForm(JForm $form, $data)
	{
		...
		{
			$form->setFieldAttribute('tos', 'description', 'PLG_USER_REGISTERGROUPS_FIELD_TOS_DESC_SITE', 'profile');
		}
	...
	public function onUserBeforeSave($user, $isnew, $data)
	{
		...
		if (!empty($data['profile']['dob']))
		{
			...
			catch (Exception $e)
			{
				...
				throw new InvalidArgumentException(JText::_('PLG_USER_REGISTERGROUPS_ERROR_INVALID_DOB'));
			}

			if (JDate::getInstance('now') < $date)
			{
				// Throw an exception if dob is greather than now.
				throw new InvalidArgumentException(JText::_('PLG_USER_REGISTERGROUPS_ERROR_INVALID_DOB_FUTURE_DATE'));
			}
		}
		...
		{
			throw new InvalidArgumentException(JText::_('PLG_USER_REGISTERGROUPS_FIELD_TOS_DESC_SITE'));
		}
